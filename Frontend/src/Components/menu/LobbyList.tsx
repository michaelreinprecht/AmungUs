...
export default function LobbyList() {
    ...
    return (
        <div className="bg-gray-800 p-14 rounded-lg border border-gray-700 h-screen">
            <button className="bg-gray-700 text-white px-4 py-2 mb-4 rounded-md shadow-md hover:bg-gray-600" onClick={fetchLobbies}>
                Refresh
            </button>
            {lobbies != undefined && lobbies.map((lobby: Lobby) => (
